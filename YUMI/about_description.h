...
#ifndef __ABOUT_DESCRIPTION_H__
#define __ABOUT_DESCRIPTION_H__
...
#define ABOUT_DESCRIPTION_MIN_WIDTH 520

class AboutDescription : public QWidget
{
    Q_OBJECT

public:
    explicit AboutDescription(void* yumiPtr, QWidget* parent = NULL);
    void updateStyles();
...
private:
    ...
    AboutDescription(QWidget* parent) = delete;

    void* _yumiPtr;
    QLabel* _logo;
    QLabel* _description;
    QHBoxLayout* _descriptionBox;
