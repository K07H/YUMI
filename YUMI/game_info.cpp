...
GameInfo::GameInfo()
{
    this->name = QString("");
    this->path = QString("");
    this->exePath = QString("");
    this->exeType = UNKNOWN_GAME;
}

GameInfo::~GameInfo() { }

GameInfo::GameInfo(const QString& gameName, const QString& gamePath, const QString& gameExePath, const int gameExeType)
{
    this->name = gameName;
    this->path = gamePath;
    this->exePath = gameExePath;
    this->exeType = gameExeType;
}
