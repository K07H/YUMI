...
#ifndef __DOWNLOADING_WINDOW_H__
#define __DOWNLOADING_WINDOW_H__
...
class DownloadingWindow : public QWidget
{
    Q_OBJECT

public:
    explicit DownloadingWindow(QWidget* parent = NULL);
