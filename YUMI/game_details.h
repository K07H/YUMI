...
public:
    explicit GameDetails(void* yumiPtr, QWidget* parent = NULL);
    ~GameDetails();
    void updateGameDetails(GameInfo* details);
    QString askSteamFolderLocation();
...
private:
    ...
    void* _yumiPtr;
    QGraphicsDropShadowEffect* _gameNameLblShadow;
    QGraphicsDropShadowEffect* _installModsLoaderBtnShadow;
    QGraphicsDropShadowEffect* _removeGameBtnShadow;
    QLabel _gameNameLbl;
    ...
    ModsListContainer* _pluginsListContainer;
