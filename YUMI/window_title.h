...
#ifndef __WINDOW_TITLE_H__
#define __WINDOW_TITLE_H__
...
public:
    explicit WindowTitle(const QString& title, QWidget* parent = NULL);
    void updateStyles();
...
private:
    WindowTitle() = delete;
    WindowTitle(QWidget* parent) = delete;

    QLabel* _appIconTransparentLbl;
    QLabel* _title;
