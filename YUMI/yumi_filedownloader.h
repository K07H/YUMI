...
#ifndef __YUMI_FILEDOWNLOADER_H__
#define __YUMI_FILEDOWNLOADER_H__
...
class YumiFileDownloader : public QObject
{
    Q_OBJECT

public:
    explicit YumiFileDownloader(const QString& url, QObject *parent = NULL);
    virtual ~YumiFileDownloader();
