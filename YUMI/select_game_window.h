...
#ifndef __SELECT_GAME_WINDOW_H__
#define __SELECT_GAME_WINDOW_H__
...
class SelectGameWindow : public QWidget
{
    Q_OBJECT

public:
    explicit SelectGameWindow(void* yumiPtr, const QString& modFileName, QWidget* parent = NULL);
...
private:
    SelectGameWindow() = delete;
    SelectGameWindow(QWidget* parent) = delete;
