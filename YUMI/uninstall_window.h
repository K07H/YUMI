...
#ifndef __UNINSTALL_WINDOW_H__
#define __UNINSTALL_WINDOW_H__
...
public:
    explicit UninstallWindow(void* yumiPtr, GameInfo* game, void* gameDetails, QWidget* parent = NULL);
...
private:
    UninstallWindow() = delete;
    UninstallWindow(QWidget* parent) = delete;

    void* _yumiPtr;
    void* _gameDetails;
    GameInfo* _game;
    WindowTitle* _title;
    QCheckBox* _includeBepInExConfigFile;
    QCheckBox* _includeAllModsAndSavedData;
