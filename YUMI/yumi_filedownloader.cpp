...
YumiFileDownloader::YumiFileDownloader(const QString& url, QObject *parent) : QObject(parent)
{
    _errorMsg = "";
...
YumiFileDownloader::~YumiFileDownloader() { }

void YumiFileDownloader::fileDownloaded(QNetworkReply* reply)
{
    if (reply != NULL)
    {
        ...
        _errorMsg = "No network reply.";
    emit downloaded();
}

QByteArray YumiFileDownloader::downloadedData() const
{
    return _downloadedData;
}

QString YumiFileDownloader::errorMsg() const
{
    return _errorMsg;
}
