...
#ifndef __BEPINEXFILE_H__
#define __BEPINEXFILE_H__
...
public:
    ...
    ~BepInExFile();
    BepInExFile(const QString& fileName, const QString& filePath, QFile* theFile);
    BepInExFile(const BepInExFile& other);
    BepInExFile& operator=(const BepInExFile&);
};
