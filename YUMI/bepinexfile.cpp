...
BepInExFile::BepInExFile(const QString& fileName, const QString& filePath, QFile* theFile)
{
    this->name = fileName;
    this->path = filePath;
    this->file = theFile;
...
BepInExFile::BepInExFile(const BepInExFile& other)
{
...
BepInExFile& BepInExFile::operator=(const BepInExFile& other)
{
    this->name = other.name;
    this->path = other.path;
    this->file = other.file;
