...
#ifndef __MODS_LIST_CONTAINER_H__
#define __MODS_LIST_CONTAINER_H__
...
class ModsListContainer : public QWidget
{
    Q_OBJECT

private slots:
    void disableModButtonClicked();
    void deleteModButtonClicked();

private:
    ModsListContainer() = delete;
    ModsListContainer(QWidget* parent) = delete;
    ...
    QString _typeName;
    QString _topLabel;
    QString _topDescription;
    QString _modsFolderName;
    QString _disabledModsFolderName;
    QString _disabledPrefix;

    bool _buttonsVisible;
    QLabel _modsListLbl;
    ModsList* _modsList;
    QPushButton _disableModBtn;
    QPushButton _deleteModBtn;
    QHBoxLayout _buttonsBox;
    QScrollArea _modsListScrollArea;
...
public:
    explicit ModsListContainer(void* yumiPtr, const bool isForPatchers, QWidget* parent = NULL);
