...
#ifndef __LICENSE_VIEWER_H__
#define __LICENSE_VIEWER_H__
...
#define LICENSE_VIEWER_WIN_MIN_WIDTH 630
class LicenseViewer : public QWidget
{
    Q_OBJECT

public:
    explicit LicenseViewer(QWidget* parent = NULL);
