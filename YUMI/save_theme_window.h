...
#ifndef __SAVE_THEME_WINDOW_H__
#define __SAVE_THEME_WINDOW_H__
...
class SaveThemeWindow : public QWidget
{
    Q_OBJECT

public:
    explicit SaveThemeWindow(void* yumiPtr, QWidget* parent = NULL);
...
private:
    SaveThemeWindow() = delete;
    SaveThemeWindow(QWidget* parent) = delete;

    void* _yumiPtr;
    WindowTitle* _title;
    QLabel* _newThemeLabel;
    QLineEdit* _newThemeName;
    QHBoxLayout* _newThemeLayout;
