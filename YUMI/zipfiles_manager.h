...
#ifndef __ZIPFILES_MANAGER_H__
#define __ZIPFILES_MANAGER_H__
...
private:
    ZipfilesManager();
    ZipfilesManager(const ZipfilesManager& other) = delete;
    ZipfilesManager& operator=(const ZipfilesManager& other) = delete;
    static ZipfilesManager* _instance;

public:
    static ZipfilesManager* Instance();
    bool unzip(const QString& filePath, const QString& destinationDir);
};
