...
private:
    ...
    explicit DebugInfo(QObject* parent = NULL);
    DebugInfo() = delete;
    DebugInfo(const DebugInfo& other) = delete;
    DebugInfo& operator=(const DebugInfo&) = delete;
    QString GetFileContent(const QString& filePath);
    QString GetFileTree(const QString& gameFolderPath, QVector<bool> tabs, bool isLastFolder = false, bool filesPresent = false);
    QString GetSteamID(const QString& str);
    QString GetOSUserName(const QString& str);
    void GetDriveLettersForDelim(QVector<QChar>& driveLetters, const QString& str, const QString& delimiter);
    QVector<QChar> GetDriveLetters(const QString& str);
    QString AnonymizeLogs(QString& str);

public:
    static DebugInfo* Init(QObject* parent = NULL);
    static DebugInfo* Instance();

    QString GetYUMILogs(bool anon = true);
    QString GetYUMIFileTree(bool anon = true);
    QString GetGameLogs(GameInfo* gameInfo, bool anon = true);
    QString GetGameFileTree(GameInfo* gameInfo, bool anon = true);
    QString GetFullDebugLogs(GameInfo* gameInfo, bool anon = true);
};
