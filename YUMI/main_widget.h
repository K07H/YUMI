...
private:
    bool _gameDetailsFirstToggle;
    QGraphicsDropShadowEffect* _scrollAreaShadow;
    QGraphicsDropShadowEffect* _gamesListLblShadow;
    QGraphicsDropShadowEffect* _addAGameBtnShadow;
    QScrollArea _scrollArea;
    QLabel _gamesListLbl;
    QLabel _noGamesInListLbl;
    QPushButton _addAGameBtn;
    QVBoxLayout* _noGamesInListLayout;
